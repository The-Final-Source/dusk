...
The **Root Orchestrator** materializes the DAG. Sequential beads run in-place; parallel beads each get a git worktree (`git worktree add -b dusk/<bead-id> <path> origin/main`).
